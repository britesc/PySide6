...
class Ui_Tab2(object):
    def setupUi(self, Tab2):
        ...
        self.actionLocateProjectFolder = QAction(Tab2)
        ...
        self.actionSaveProjectFolder = QAction(Tab2)
        ...
        self.actionCancelProjectFolder = QAction(Tab2)
        ...
        self.labelConfigCopyright = QLabel(Tab2)
        ...
        self.groupBoxLocateApps = QGroupBox(Tab2)
    ...
    def retranslateUi(self, Tab2):
        ...
        self.actionLocateProjectFolder.setText(QCoreApplication.translate("Tab2", u"Locate", None))
#if QT_CONFIG(tooltip)
        self.actionLocateProjectFolder.setToolTip(QCoreApplication.translate("Tab2", u"Locate Project Master Folder", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionLocateProjectFolder.setShortcut(QCoreApplication.translate("Tab2", u"Ctrl+F", None))
#endif // QT_CONFIG(shortcut)
        self.actionSaveProjectFolder.setText(QCoreApplication.translate("Tab2", u"Save", None))
#if QT_CONFIG(tooltip)
        self.actionSaveProjectFolder.setToolTip(QCoreApplication.translate("Tab2", u"Save Master Project Folder", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionSaveProjectFolder.setShortcut(QCoreApplication.translate("Tab2", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.actionCancelProjectFolder.setText(QCoreApplication.translate("Tab2", u"Cancel", None))
#if QT_CONFIG(tooltip)
        self.actionCancelProjectFolder.setToolTip(QCoreApplication.translate("Tab2", u"Cancel Amendments to Master Project Folder", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionCancelProjectFolder.setShortcut(QCoreApplication.translate("Tab2", u"Ctrl+Z", None))
#endif // QT_CONFIG(shortcut)
        self.groupBoxProjectFolder.setTitle(QCoreApplication.translate("Tab2", u"Project Folder Wizard", None))
        self.labelTextProjectFolder.setText(QCoreApplication.translate("Tab2", u"Please select the location of your Project Folder Master", None))
        self.lineEditDisplayProjectFolder.setPlaceholderText(QCoreApplication.translate("Tab2", u"Project Folder Location", None))
#if QT_CONFIG(statustip)
        self.pushButtonLocateMasterProjectFolder.setStatusTip(QCoreApplication.translate("Tab2", u"Locate Master  Project Folder", None))
#endif // QT_CONFIG(statustip)
        self.pushButtonLocateMasterProjectFolder.setText(QCoreApplication.translate("Tab2", u"Locate", None))
#if QT_CONFIG(shortcut)
        self.pushButtonLocateMasterProjectFolder.setShortcut(QCoreApplication.translate("Tab2", u"Ctrl+F", None))
#endif // QT_CONFIG(shortcut)
        self.pushButtonSaveMasterProjectFolder.setText(QCoreApplication.translate("Tab2", u"Save", None))
#if QT_CONFIG(shortcut)
        self.pushButtonSaveMasterProjectFolder.setShortcut(QCoreApplication.translate("Tab2", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.pushButtonCancelMasterProjectsFolder.setText(QCoreApplication.translate("Tab2", u"Cancel", None))
#if QT_CONFIG(shortcut)
        self.pushButtonCancelMasterProjectsFolder.setShortcut(QCoreApplication.translate("Tab2", u"Ctrl+Z", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.labelConfigCopyright.setText(QCoreApplication.translate("Tab2", u"<html><head/><body><p align=\"center\"><span style=\" font-size:small; font-weight:700;\">Copyright J2Casa 2023. All Rights Reserved</span></p></body></html>", None))
        self.groupBoxLocateApps.setTitle(QCoreApplication.translate("Tab2", u"Applications Locations Wizard", None))
    # retranslateUi
